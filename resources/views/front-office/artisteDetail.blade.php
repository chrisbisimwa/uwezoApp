                ...
                <div class="row align-items-start align-items-md-center">
                    <div class="col-lg-4 col-sm-4">
                        <div class="andro_artist-d-img">
                            <img class="andro_img-cover" src="{{ \Storage::url('uploads/' . $artisteDetail->photo) }}">
                        ...
                        <div class="andro_artist-d-content">
                            ...
                            <div class="andro_artist-d-meta">
                                <div class="andro_artist-d-meta-item">
                                    ...
                                    <span>{{ $datenaissance = date('d-m-Y', strtotime($artisteDetail->datenaissance)) }} <b
                                            class="fw-500 color-primary">( {{ $age }} ans)</b> </span>
                                </div>
                                <div class="andro_artist-d-meta-item">
                                    <b>Oeuvres: </b>
                                    @foreach ($oeuvre as $oeuvreArtiste)
                                        <span><a href="{{ $oeuvreArtiste->source }}"
                                                target="_blank">{{ $oeuvreArtiste->nom }},</a></span>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                @foreach ($oeuvre as $oeuvreArti)
                                    @if ($oeuvreArti->type == 'Image')
                                        <div class="andro_track style-2 andro_audio-track">
                                            ...
                                            <div class="andro_track-img">
                                                <a href="{{ \Storage::url('uploads/' . $oeuvreArti->image) }}"
                                                    class="andro_img-popup andro_gallery">
                                                    <img src="{{ \Storage::url('uploads/' . $oeuvreArti->image) }}"
                                                        alt="track"></a>
                                            ...
                                            <div class="andro_track-content">
                                                ...
                                                <div class="andro_track-footer">
                                                    <div class="andro_track-data">
                                                        <span>{{ $artisteDetail->nom }}
                                                            {{ $artisteDetail->prenom }}</span>
                                    ...
                                    @else
                                        <div class="andro_track style-2 andro_audio-track">
                                            ...
                                            <div class="andro_track-img">
                                                <div class="col-lg-6">
                                                    <div class="position-relative h-100">
                                                        ...
                                                        <a href="https://www.youtube.com/watch?v={{ getYouTubeVideoId($oeuvreArti->source) }}"
                                                            target="_blank">
                                                            <img src="https://img.youtube.com/vi/{{ getYouTubeVideoId($oeuvreArti->source) }}/maxresdefault.jpg"
                                            ...
                                            <div class="andro_track-content">
                                                <h5><a href="{{ $oeuvreArti->source }}"
                                                        target="_blank">{{ $oeuvreArti->nom }}</a></h5>
                                                <div class="andro_track-footer">
                                                    <div class="andro_track-data">
                                                        <span>{{ $artisteDetail->nom }}
                                                            {{ $artisteDetail->prenom }}</span>
