...
<body>
    <div class="email-container">
        ...
        <h1>Nouvel artiste disponible !</h1>
        <p>Un nouvel artiste dénommé <strong>"{{ $artist->nom }} {{ $artist->prenom }}"</strong> a été publié sur SANAA YETU.</p>
        {{-- <p>{{$blogPost->short_content() }}...</p> --}}
        <a href="{{ route('front.artisteDetail', $artist->slug) }}" class="button">Voir l'artiste</a>
        <div class="footer">
