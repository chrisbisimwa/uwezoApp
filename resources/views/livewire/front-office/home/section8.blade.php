<div class="section md blue-bg" style="background-image: url(front-office-assets/img/texture-2.png)"
    ...
    <div class="andro_instagram d-none d-lg-block container mb-negative lg">
        ...
        <div class="row gx-0">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <a href="#"><img src="{{ asset('front-office-assets/img/instagram/3.jpg') }}" alt="instagram"></a>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-6">
                <a href="#"><img src="{{ asset('front-office-assets/img/instagram/4.jpg') }}" alt="instagram"></a>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-6">
                <a href="#"><img src="{{ asset('front-office-assets/img/instagram/2.jpg') }}" alt="instagram"></a>
            </div>
