    ...
    <div class="modal-body">
        <div class="row gy-3">
            ...
            <div class="col-xl-6">
                ...
                <input type="date" class="form-control @error('date') is-invalid @enderror" id="date-oeuvre-add" placeholder="Date de sortie",
                    wire:model="date">
                    @error('date')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
            ...
            <div class="col-xl-6">
                ...
                <select class="form-control @error('status') is-invalid @enderror" data-trigger name="status-oeuvre-add" id="status-oeuvre-add"
                    wire:model="status">
                    <option value="">Sélectionner</option>
                    <option value="Image">Activé</option>
                    <option value="Vidéo">Désactivé</option>
                </select>
                @error('status')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
            ...
            <div class="col-xl-12">
                ...
                <input type="file" class="form-control @error('image') is-invalid @enderror" id="image-oeuvre-add" wire:model="image">
            ...
            <div class="col-xl-12">
                ...
                <input type="text" class="form-control @error('source') is-invalid @enderror" id="source-oeuvre-add" wire:model="source">
