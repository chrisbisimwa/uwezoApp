            ...
            <div class="card-body p-0">
                ...
                <div class="p-4 border-bottom border-block-end-dashed d-flex align-items-center">
                    ...
                    <div class="btn-list mb-0">
                        ...
                        <a href="{{ $artist->facebook_link }}" class="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light" target="_blank">
                            <i class="ri-facebook-line fw-semibold"></i>
                        </a>
                        @endif
                        @if($artist->twitter_link)
                        <a href="{{ $artist->twitter_link }}" class="btn btn-sm btn-icon btn-secondary-light btn-wave waves-effect waves-light" target="_blank">
                            <i class="ri-twitter-line fw-semibold"></i>
                        </a>
                        @endif
                        @if($artist->instagram_link)
                        <a href="{{ $artist->instagram_link }}" class="btn btn-sm btn-icon btn-warning-light btn-wave waves-effect waves-light" target="_blank">
                            <i class="ri-instagram-line fw-semibold"></i>
                        </a>
                        @endif
                       @if($artist->soundcloud_link)
                        <a href="{{ $artist->soundcloud_link }}" class="btn btn-sm btn-icon btn-info-light btn-wave waves-effect waves-light" target="_blank">
                            <i class="ri-soundcloud-line fw-semibold"></i>
                        </a>
                        @endif
                       @if($artist->youtube_link)
                        <a href="{{ $artist->youtube_link }}" class="btn btn-sm btn-icon btn-danger-light btn-wave waves-effect waves-light" target="_blank">
