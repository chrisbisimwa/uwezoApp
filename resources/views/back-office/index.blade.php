...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xxl-6 col-xl-12 col-lg-6 col-md-12">
                        ...
                        <li class="timeline-widget-list">
                            <div class="d-flex align-items-top">
                                <div class="me-5 text-center">
                                    <span class="d-block fs-20 fw-semibold text-primary">{{ $event->start_date->format('d') }}</span>
                                    <span class="d-block fs-12 text-muted">{{ $event->start_date->format('D') }}</span>
                                </div>
                                <div class="d-flex flex-wrap flex-fill align-items-top justify-content-between">
                                    <div>
                                        <p class="mb-1 text-truncate timeline-widget-content text-wrap">{{ $event->title }}</p>
                                        <p class="mb-0 fs-12 lh-1 text-muted">{{ $event->start_date->format('H:s') }}<span class="badge bg-primary-transparent ms-2">Announcement</span></p>
                                    </div>
                                    <div class="dropdown">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
            <div class="card custom-card overflow-hidden">
                <div class="card-header justify-content-between">
                    ...
                    <div class="dropdown">
                        <a href="{{route('blog.index')}}" class="p-2 fs-12 text-muted" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <a href="javascript:void(0);">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <span class="badge bg-success-transparent">{{ $blog->created_at->format('d/m/Y H:i:s') }}</span>
                                    </div>
                                </div>
                            </a>
                        </li>
